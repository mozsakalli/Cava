...
package debugger.handler.eventrequest.events.predicates;

import debugger.handler.eventrequest.events.EventData;
...
public class EventClassNameMatchPredicate extends EventPredicate {
    ...
    public EventClassNameMatchPredicate(int eventKind, String pattern, boolean negative) {
        super(eventKind);
