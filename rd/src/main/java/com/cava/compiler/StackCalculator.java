...
public class StackCalculator extends EmptyVisitor {
    ...
    static class Stack {
        ...
        public String pop() {
            size--;
            return !types.isEmpty() ? types.remove(types.size() - 1) : null;
        }
    ...
    public String getType() { return stack.types.isEmpty() ? null : stack.types.get(stack.types.size()-1); }
