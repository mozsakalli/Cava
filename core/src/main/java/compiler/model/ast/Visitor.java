...
public class Visitor {
    ...
    public void arrayAccess(ArrayAccess aa) { code(aa); }
    public void arrayLength(ArrayLength al) { code(al); }
    public void assign(Assign a) { code(a); }
    public void binary(Binary b) { code(b); }
    public void block(Block b) { code(b); }
    public void endBlock(Block b) { code(b); }
    public void break_(Break b) { code(b); }
    public void call(Call c) { code(c); }
    public void cast(Cast c) { code(c); }
    public void checkCast(CheckCast c) { code(c); }
    public void classRef(ClassRef c) { code(c); }
    ...
    public void newArray(NewArray n) { code(n); }
