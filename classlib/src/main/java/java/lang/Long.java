...
public final class Long extends Number implements Comparable<Long> {
     ...
     *
     * @param value the primitive long value to store in the new instance.
     */
     ...
     * relative order.
     *
     * @param object the long object to compare this object to.
     ...
     * {@code object} are equal; a positive value if the value of this long is
     ...
     * @return a {@code Long} containing the value represented by
     * {@code string}.
     * @throws NumberFormatException if {@code string} cannot be parsed as a
     * long value.
     */
     ...
     *
     * @param o the object to compare this long with.
     ...
     * {@code string}. Returns {@code null} if {@code string} is {@code null} or
     * empty, if the property can not be found or if its value can not be parsed
     * as a long.
     *
     ...
     *
     * @param string the name of the requested system property.
     * @param defaultValue the default value that is returned if there is no
     * long system property with the requested name.
     ...
     * {@code radix}.
     * @throws NumberFormatException if {@code string} cannot be parsed as a
     * long value, or      {@code radix < Character.MIN_RADIX ||
    ...
    /**
     * Converts the specified signed long value into a string representation
     * based on the specified radix. The returned string is a concatenation of a
     * minus sign if the number is negative and characters from '0' to '9' and
     * 'a' to 'z', depending on the radix. If {@code radix} is not in the
     * interval defined by {@code Character.MIN_RADIX} and
     * {@code Character.MAX_RADIX} then 10 is used as the base for the
     * conversion.
     *
     * <p>
     ...
     * number of bits.
     *
     * @param v the long value to rotate left.
     ...
     *
     * @param v the long value to rotate right.
     * @param distance the number of bits to rotate.
     * @return the rotated value.
     * @since 1.5
     */
     ...
     *
     * @param v the long value for which to reverse the byte order.
     ...
     *
     * @param v the long value for which to reverse the bit order.
     * @return the reversed value.
     * @since 1.5
     */
     ...
     *
     * @param v the long value to store in the instance.
