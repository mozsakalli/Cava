...
public final class Math {
    ...
    public static double acos(double d) {
        return NativeCode.Double("acos(%s)", d);
    }
    ...
    public static double asin(double d) {
        return NativeCode.Double("asin(%s)", d);
    }
    ...
    public static double atan(double d) {
        return NativeCode.Double("atan(%s)", d);
    }
    ...
    public static double atan2(double y, double x) {
        return NativeCode.Double("atan2(%s,%s)", y,x);
    }
     ...
     * </ul>
     *
     * @param d the value whose cube root has to be computed.
     * @return the cube root of the argument.
     */
    public static double cbrt(double d) {
        return NativeCode.Double("cbrt(%s)", d);
    }
    ...
    public static  double ceil(double d) {
        return NativeCode.Double("ceil(%s)", d);
    }
    ...
    public static double cos(double d) {
        return NativeCode.Double("cos(%s)", d);
    }
     ...
     * </ul>
     *
     * @param d the value whose hyperbolic cosine has to be computed.
     * @return the hyperbolic cosine of the argument.
     */
    public static double cosh(double d) {
        return NativeCode.Double("cosh(%s)", d);
    }
    ...
    public static double exp(double d) {
        return NativeCode.Double("exp(%s)", d);
    }
     ...
     * </ul>
     *
     * @param d the value to compute the <i>{@code e}</i><sup>{@code d} </sup>
     * {@code - 1} of.
     * @return the <i>{@code e}</i><sup>{@code d}</sup>{@code - 1} value of the
     * argument.
     */
    public static double expm1(double d) {
        return NativeCode.Double("expm1(%s)", d);
    }
    ...
    public static double floor(double d) {
        return NativeCode.Double("floor(%s)", d);
    }
     ...
     * <i> {@code y}</i><sup>{@code 2}</sup>{@code )} value of the arguments.
     */
    public static double hypot(double x, double y) {
        return NativeCode.Double("hypot(%s,%s)", x,y);
    }
     ...
     * </ul>
     *
     * @param x the numerator of the operation.
     * @param y the denominator of the operation.
     * @return the IEEE754 floating point reminder of of {@code x/y}.
     */
    public static double IEEEremainder(double x, double y) {
        return NativeCode.Double("remainder(%s,%s)", x,y);
    }
    ...
    public static double log(double d) {
        return NativeCode.Double("log(%s)", d);
    }
    ...
    public static double log10(double d) {
        return NativeCode.Double("log10(%s)", d);
    }
     ...
     * </ul>
     *
     * @param d the value to compute the {@code ln(1+d)} of.
     * @return the natural logarithm of the sum of the argument and 1.
     */
    public static double log1p(double d) {
        return NativeCode.Double("log1p(%s)", d);
    }
 ...
 /* 0x80000000 == Float.floatToRawIntBits(-0.0f) */
    ...
    public static double pow(double x, double y) {
        return NativeCode.Double("pow(%s,%s)", x,y);
    }
    ...
    public static double rint(double d) {
        return NativeCode.Double("rint(%s)", d);
    }
    ...
    public static double sin(double d) {
        return NativeCode.Double("sin(%s)", d);
    }
     ...
     * </ul>
     *
     * @param d the value whose hyperbolic sine has to be computed.
     * @return the hyperbolic sine of the argument.
     */
    public static double sinh(double d) {
        return NativeCode.Double("sinh(%s)", d);
    }
    ...
    public static double sqrt(double d) {
        return NativeCode.Double("sqrt(%s)", d);
    }
    ...
    public static double tan(double d) {
        return NativeCode.Double("tan(%s)", d);
    }
     ...
     * </ul>
     *
     * @param d the value whose hyperbolic tangent has to be computed.
     * @return the hyperbolic tangent of the argument.
     */
    public static double tanh(double d) {
        return NativeCode.Double("tanh(%s)", d);
    }
     ...
     * </ul>
     *
     * @param d the floating-point value to compute ulp of.
    ...
    private static double nextafter(double x, double y) {
        return NativeCode.Double("nextafter(%s,%s)", x,y);
    }
     ...
     * </ul>
     *
     * @param f the floating-point value to compute ulp of.
     * @return the size of a ulp of the argument.
     */
    ...
    /**
     * Returns the next float after {@code start} in the given
     * {@code direction}.
     *
     * @since 1.6
     */
