...
public final class Double extends Number implements Comparable<Double> {
    ...
    /**
     * Constant for the smallest positive normal value of the {@code double}
     * type.
     *
     * @since 1.6
     */
    ...
    /**
     * Maximum base-2 exponent that a finite value of the {@code double} type
     * may have. Equal to {@code Math.getExponent(Double.MAX_VALUE)}.
     *
     * @since 1.6
     */
    ...
    /**
     * Minimum base-2 exponent that a normal value of the {@code double} type
     * may have. Equal to {@code Math.getExponent(Double.MIN_NORMAL)}.
     *
     * @since 1.6
     */
     ...
     * @throws NumberFormatException if {@code string} cannot be parsed as a
     * double value.
     ...
     * than any other double value, including
     * {@code Double.POSITIVE_INFINITY};</li>
     * <li>+0.0d is greater than -0.0d</li>
     * </ul>
     *
     * @param object the double object to compare this object to.
     * @return a negative value if the value of this double is less than the
     * value of {@code object}; 0 if the value of this double and the value of
     * {@code object} are equal; a positive value if the value of this double is
     ...
     * <a href="http://en.wikipedia.org/wiki/IEEE_754-1985">IEEE 754</a> double
     * precision {@code value}. All <em>Not-a-Number (NaN)</em> values are
     * converted to a single NaN representation ({@code 0x7ff8000000000000L})
     * (compare to {@link #doubleToRawLongBits}).
     */
    public static long doubleToLongBits(double value) {
        if(VM.isNaN(value)) return 0x7ff8000000000000l;
        return VM.doubleToLong(value);
    }

    /**
     * Returns an integer corresponding to the bits of the given
     * <a href="http://en.wikipedia.org/wiki/IEEE_754-1985">IEEE 754</a> double
     * precision {@code value}. <em>Not-a-Number (NaN)</em> values are preserved
     * (compare to {@link #doubleToLongBits}).
     */
     ...
     * {@code object} must be an instance of {@code Double} and
     ...
     *
     * @param object the object to compare this double with.
     ...
     * </ul>
     *
     * @param double1 the first value to compare.
     * @param double2 the second value to compare.
     * @return a negative value if {@code double1} is less than {@code double2};
     * 0 if {@code double1} and {@code double2} are equal; a positive value if
     * {@code double1} is greater than {@code double2}.
     */
     ...
     *
     * @param d the double value to store in the instance.
