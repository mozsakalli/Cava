...
class Array {
    ...
    public static int getLength(Object array)
        ...
        return NativeCode.Int("((JvmArray*)%s)->len", array);
    }
    ...
    private static Object newArray(Class componentType, int length) throws NegativeArraySizeException {
        ...
        if(componentType.isPrimitive()) {
            return NativeCode.Object("JvmAllocPrimArray1(%s,%s)", Class.getArrayClassFor(componentType), length);
        } else {
            return NativeCode.Object("JvmAllocObjectArray1(%s,%s)", Class.getArrayClassFor(componentType), length);
        }
    }
    ...
    private static Object multiNewArray(Class componentType,
        ...
        if(componentType.isPrimitive()) {
            switch(dimensions.length) {
                case 2: {
                    return NativeCode.Object("JvmAllocPrimArray2(%s,%s,%s)", Class.getArrayClassFor(componentType), dimensions[0], dimensions[1]);
                }
            }
        } else {
            switch(dimensions.length) {
                case 2: return NativeCode.Object("JvmAllocObjectArray2(%s,%s,%s)", Class.getArrayClassFor(componentType), dimensions[0], dimensions[1]);
            } 
        }
        throw new IllegalArgumentException("Max 2 dimension array supported");
    }
